...
const Demo = {
    ...
    async demoBarChart() {
        ...
        await this.sleep(200);
        this.searchInput.value = "Du";
        await this.sleep(200);
        this.searchInput.value = "Dur";
        await this.sleep(200);
        this.searchInput.value = "Dura";
        await this.sleep(200);
        this.searchInput.value = "Duran";
        await this.sleep(200);
        this.searchInput.value = "Durant";
        await this.sleep(500);
        this.searchPlayer("Durant");
        await this.sleep(500);
        this.startSeasonToggle.value = 2020;
